...
const Step1: NextPage = () => {
  ...
  return (
    <div className="relative flex flex-col justify-between w-[100vw] h-[100vh] min-w-[375px] overflow-hidden mx bg-[url(../public/step-1@3x.png)] bg-cover bg-no-repeat bg-[top] text-center text-base text-white font-body-date1">
      <div className="w-full h-full flex  flex-col py-0 px-5 box-border items-center justify-between text-center text-base text-light-grey-8001 font-body-date1">
        ...
        <div
          className="rounded-3xl p-[2px]  shadow-sm w-full h-full flex-2
            bg-gradient-to-t from-[#9747FF]  via-[#26F4DE] to-[#1f1f1f]"
        >
