  ...
  return (
    <Layout>
      <div className="w-full h-full flex-1 flex flex-col items-center justify-between">
        <div className="w-full h-full flex-1 flex flex-col items-center justify-between py-0 px-5 box-border text-center text-base text-light-grey-8001 font-body-date1">
          <div className="rounded-3xl p-[2px]  shadow-sm w-full h-full flex-1 flex flex-col bg-gradient-to-t from-[#9747FF]  via-[#26F4DE] to-[#1f1f1f]">
            <div className="relative rounded-3xl flex-1 justify-between bg-[#1f1f1f] [background:black shadow-[0px_12px_40px_rgba(0,_0,_0,_0.5)] w-full h-full flex flex-col pt-[42px] px-5 pb-[92px] box-border items-center  gap-[32px]">
